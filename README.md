...
- [surrealdb-spring-client](https://github.com/Mukund2900/surrealdb-spring-client) - An unofficial maven library can be used to easily integrate surrealdb with springboot.
